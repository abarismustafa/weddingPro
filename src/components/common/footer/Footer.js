    ...
    return (
        <footer className="bg-gray-900 text-gray-300">
            <div className="container mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        {["Search By Vendor", "Search By City", "Download Our App", "Top Rated Vendors", "Destination Wedding"].map(
                            (item, i) => (
                                <li key={i}>
                                    <a
                                        href="#"
                ...
                <div>
                    ...
                    <ul className="space-y-2">
                        {["Wedding Blog", "Wedding Inspiration Gallery", "Real Wedding", "Submit Wedding"].map(
                            (item, i) => (
                                <li key={i}>
                                    <a
                                        href="#"
            ...
            <div className="border-t border-gray-700 mt-8 py-4 text-center text-sm text-gray-400">
                © {new Date().getFullYear()} Wedding Spot Designed By <a href="https://www.abarissoftech.com/" target="blank">Abaris Softech</a>
            </div>
        </footer>
    );
};
