...
import { allChoreographers } from "@/data/choreographersData";
import { FaChevronLeft, FaChevronRight } from "react-icons/fa";

const TrendingChoreographers = () => {
  ...
  return (
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        ...
        {/* Scrollable Choreographer Cards (No scrollbar) */}
        <div className="relative">
          <div
            ref={scrollContainerRef}
            className="flex gap-6 overflow-x-hidden" // Hides scrollbar completely
          >
            {allChoreographers.map((choreographer, index) => (
              <div
                key={index}
              ...
              >
                <div className="relative w-full h-[200px]">
                  ...
                  <div className="absolute top-3 right-3 bg-green-500 text-white text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1">
                    ⭐ {choreographer.rating.toFixed(1)}
                  </div>
                </div>
                <div className="p-4">
...
export default TrendingChoreographers;
